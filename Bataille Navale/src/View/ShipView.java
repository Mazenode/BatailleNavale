...
public class ShipView extends JPanel{
	...
	public ShipView(String spriteShip, String spriteShipTurn, int longueur, int posX, int posY, int[][] grid){
		this.setVisible(true);
		this.setLayout(null);
		this.setOpaque(false);
		this.setBounds(posX,posY,10+(width/28), 10+(longueur*width/28));
		this.grid = grid;
        ...
        ShipController shipcontrol = new ShipController(this, ship,10+(width/28), 10+(longueur*width/28),idShip);
